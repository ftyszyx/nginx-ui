...
replace github.com/uozi-tech/cosy-driver-mysql => ../cosy-driver-mysql

replace github.com/uozi-tech/cosy-driver-postgres => ../cosy-driver-postgres

replace github.com/uozi-tech/cosy-driver-sqlite => ../cosy-driver-sqlite
